 ...
 */     
    public static function system_error($msglog = NULL, $msgoutput = NULL, $httpcode = NULL){
        ...
        $msggeneral = "Ocurrió un error con el servicio, favor de contactár al administrador...!!!";
        
        $_msg = $msglog ? $msglog : $msggeneral;
        $msgoutput = $msgoutput ? $msgoutput : $msggeneral;
        ...
        header('Content-Length: ' . strlen($msgoutput));
        header('Warning: ' . $_msg);
